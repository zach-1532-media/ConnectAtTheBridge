...
const colors = {
  ...
  tertiary: {
    lighter: lighten(themeColors.tertiary, 0.85),
    light: lighten(themeColors.tertiary, 0.3),
    main: themeColors.tertiary,
    dark: darken(themeColors.tertiary, 0.2),
  },
  alternate: {
    lighter: lighten(themeColors.alternate, 0.85),
    light: lighten(themeColors.alternate, 0.3),
    main: themeColors.alternate,
    dark: darken(themeColors.alternate, 0.2),
  },
  success: {
...
export const theme = createTheme({
  colors: {
    ...
    tertiary: {
      lighter: alpha(themeColors.tertiary, 0.1),
      light: lighten(themeColors.tertiary, 0.3),
      main: themeColors.tertiary,
      dark: darken(themeColors.tertiary, 0.2),
    },
  ...
  palette: {
    ...
    alternate: {
      light: colors.alternate.light,
      main: colors.alternate.main,
      dark: colors.alternate.dark,
    },
    error: {
